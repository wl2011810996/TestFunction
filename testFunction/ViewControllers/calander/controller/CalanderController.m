...
@interface CalanderController ()

@end

@implementation CalanderController
...
-(void)setupConfig
{
    ...
    selectBtn.frame = CGRectMake(20, 100,200, 50);
    ...
    selectBtn2.frame = CGRectMake(20, 200, 300, 50);
